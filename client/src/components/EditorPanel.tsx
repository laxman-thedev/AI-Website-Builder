            ...
            <div className="space-y-4 text-black">
                ...
                <div className="grid grid-cols-2 gap-3">
                    <div>
                        ...
                        <input type="text" value={values.styles.backgroundColor === 'rgba(0, 0, 0, 0)' ? '#ffffff' : values.styles.backgroundColor} onChange={(e) => handleStyleChange('backgroundColor', e.target.value)} className="w-full text-sm p-2 border  border-gray-400 rounded-md focus:ring-2 focus:ring-indigo-500 outline-none" />
                    </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-3">
                    <div>
                        ...
                        <div className="flex items-center gap-2 border border-gray-400 rounded-md p-1">
                            <input type="text" value={values.styles.fontSize} onChange={(e) => handleStyleChange('fontSize', e.target.value)} className="w-6 h-6 cursor-pointer" />
                            <span className="text-xs to-gray-600 truncate" >{values.styles.backgroundColor}</span>
                        </div>
                    </div>
                    <div>
                        ...
                        <div className="flex items-center gap-2 border border-gray-400 rounded-md p-1">
                            ...
                            <span className="text-xs to-gray-600 truncate" >{values.styles.color}</span>
                        </div>
                    </div>
                </div>
